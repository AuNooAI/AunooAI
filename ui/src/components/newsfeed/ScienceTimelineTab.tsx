...
export function ScienceTimelineTab({
  dayOfWeek,
  dailyIntensity,
  temporalData,
  loading,
  onLoad,
}: ScienceTimelineTabProps) {
          ...
          <div>
            ...
            <ResponsiveContainer width="100%" height={350}>
              ...
              >
                ...
                />
                <Legend />
                <Bar dataKey="count" fill="#10B981" name="Daily Count" opacity={0.6} />
                <Line
                  type="monotone"
          ...
          <div>
            ...
            <ResponsiveContainer width="100%" height={350}>
              ...
              >
                ...
                />
                <Bar dataKey="article_count" fill="#10B981" name="Articles" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        )}
