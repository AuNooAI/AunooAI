/**
 * Science Category Analysis Tab Component
 * AI-powered insights for individual science funding categories
 */
...
interface ScienceCategoryAnalysisTabProps {
  categories: ScienceCategory[];
  topic: string;
  daysBack: number;
}

export function ScienceCategoryAnalysisTab({ categories, topic, daysBack }: ScienceCategoryAnalysisTabProps) {
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
          ...
          <p className="text-xs text-gray-600 dark:text-gray-300 mb-4">
            Select a science funding category to generate AI-powered analysis and insights. Each analysis examines trends,
            key themes, and connections to other funding areas.
          </p>
          ...
          <div className="space-y-4">
            <div className="flex gap-2">
              <select
                ...
                className="flex-1 px-3 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 disabled:opacity-50"
              >
              ...
              {selectedInsightCategory && (
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 text-sm bg-emerald-500 text-white rounded-lg hover:bg-emerald-600 disabled:opacity-50 transition-colors"
                >
            ...
            {selectedInsightCategory && categoryInsights[selectedInsightCategory] && !loadingCategoryInsight && (
              <div className="p-5 bg-gradient-to-br from-gray-50 to-emerald-50/30 dark:from-gray-800 dark:to-emerald-900/10 rounded-xl shadow-inner border border-gray-100 dark:border-gray-700">
