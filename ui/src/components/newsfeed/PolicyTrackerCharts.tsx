/**
 * Policy Tracker Charts Component
...
import type { PolicyCategory, TemporalData } from '../../services/policyTrackerApi';
import { CATEGORY_COLORS, CATEGORY_SHORT_NAMES, CATEGORY_DESCRIPTIONS } from '../../services/policyTrackerApi';

interface PolicyTrackerChartsProps {
...
export function PolicyTrackerCharts({
  categories,
  temporalData,
  loading,
}: PolicyTrackerChartsProps) {
