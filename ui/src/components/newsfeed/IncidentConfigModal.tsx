      ...
      <DialogContent className="w-auto min-w-[600px] max-w-[95vw] h-[90vh] flex flex-col">
        ...
        <div className="flex-1 min-h-0 overflow-y-auto">
          <Tabs defaultValue="info" className="h-full">
            <TabsList className="w-full shrink-0 flex sticky top-0 bg-white z-10">
                  ...
                  <div className="space-y-4 min-w-0">
                    <div className="bg-gray-50 rounded-lg p-4">
                      ...
                      <div className="space-y-3 text-sm">
                        <div>
                          <p className="font-medium text-gray-700">Analysis Quality:</p>
                        ...
                        <div>
                          <p className="font-medium text-gray-700">Profile Context:</p>
                          <ul className="text-gray-600 list-disc list-inside mt-1 space-y-0.5">
...
function PlaceholderItem({ name, desc }: { name: string; desc: string }) {
  return (
    <div>
      <code className="text-pink-600 bg-pink-50 px-1 py-0.5 rounded text-xs">{name}</code>
...
function TypeItem({ type, desc }: { type: string; desc: string }) {
  return (
    <div>
      <code className="text-blue-600 bg-blue-50 px-1 py-0.5 rounded text-xs">{type}</code>
      <p className="text-gray-500 text-xs mt-0.5">{desc}</p>
    </div>
  );
}
