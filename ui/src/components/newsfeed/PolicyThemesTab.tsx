...
import { THEME_COLORS, ESCALATION_COLORS } from '../../services/policyTrackerApi';

interface PolicyThemesTabProps {
  themes: ThemeData[];
...
export function PolicyThemesTab({
  themes,
  themesEvolution,
  entities,
  geography,
              ...
              <div>
                ...
                <ResponsiveContainer width="100%" height={350}>
                  ...
                  >
                    ...
                    />
                    <Bar dataKey="mention_count" fill="#8B5CF6" name="Mentions" radius={[4, 4, 0, 0]} />
                  </BarChart>
                </ResponsiveContainer>
              </div>
            )}
                  ...
                  <div>
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                      ...
                      >
                        ...
                        />
                        <Bar dataKey="mention_count" fill="#14B8A6" radius={[0, 4, 4, 0]} />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
                </div>
