            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300 mt-0.5">
                    {totalCount} articles
          ...
          <div className="p-6">
            ...
            {initialLoading ? (
              <div className="flex flex-col items-center justify-center py-16">
                ...
                <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300">Loading articles...</p>
              </div>
            ) : articles.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <p className="text-gray-700 dark:text-gray-300 dark:text-gray-300 mt-1">
              ...
              <div className="space-y-4">
                        ...
                        <div className="flex flex-wrap items-center gap-2 text-sm">
                          ...
                          {article.publication_date && (
                            <>
                              ...
                              <div className="flex items-center gap-1 text-gray-700 dark:text-gray-300 dark:text-gray-300">
                        ...
                        <div className="flex items-center gap-1 shrink-0">
                          ...
                          >
                            {isStarred ? (
                              ...
                              <StarOff className="w-4 h-4 text-gray-600 dark:text-gray-300 hover:text-yellow-500" />
                            )}
                          </button>
                        </div>
                      </div>
                ...
                {!hasMore && articles.length > 0 && (
                  <div className="text-center py-4 text-sm text-gray-700 dark:text-gray-300 dark:text-gray-300">
