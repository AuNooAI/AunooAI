    ...
    <section className="mb-6">
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        >
          ...
          <ChevronRight className="w-4 h-4 text-gray-600 dark:text-gray-300 group-hover:text-blue-600" />
        </button>
    ...
    <div className="group relative">
      ...
      >
              ...
              <div className="mt-2 flex items-center gap-2 text-xs">
                ...
                {cluster.primary.time_to_impact && (
                  <>
                    ...
                    <span className="text-gray-600 dark:text-gray-300">{cluster.primary.time_to_impact}</span>
                  </>
                )}
              </div>
            )}
        ...
        <div className="flex items-center gap-2 mt-1.5 text-xs">
          ...
          {cluster.primary.publication_date && (
            <>
              <span className="text-gray-600 dark:text-gray-300 dark:text-gray-700 dark:text-gray-300">·</span>
      ...
      {hasRelated && showRelated && (
        <div className="mx-2 mb-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700">
          <div className="text-xs font-medium text-gray-700 dark:text-gray-300 dark:text-gray-300 uppercase tracking-wide mb-2">
          ...
          <div className="space-y-2">
            ...
            >
              <div className="flex items-center gap-2 text-xs mb-1">
                ...
                {cluster.primary.publication_date && (
                  <span className="text-gray-600 dark:text-gray-300">{formatTimeAgo(cluster.primary.publication_date)}</span>
                )}
              </div>
                ...
                >
                  <div className="flex items-center gap-2 text-xs mb-1">
                    ...
                    {related.publication_date && (
                      <span className="text-gray-600 dark:text-gray-300">{formatTimeAgo(related.publication_date)}</span>
                    )}
                  </div>
            ...
            {relatedArticles.length > 4 && (
              <p className="text-xs text-gray-600 dark:text-gray-300 text-center py-1">
