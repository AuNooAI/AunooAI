/**
 * Science Article List Component
 * Displays filterable list of science funding tracker articles
 */
...
import type { ScienceArticle, ScienceCategory } from '../../services/scienceFundingApi';
import { CATEGORY_COLORS, CATEGORY_SHORT_NAMES } from '../../services/scienceFundingApi';

interface ScienceArticleListProps {
  ...
  onClearSearch: () => void;
  onArticleClick: (article: ScienceArticle) => void;
  onFindRelated: (uri: string) => void;
}

export function ScienceArticleList({
  articles,
  categories,
  selectedCategories,
  totalCount,
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <form onSubmit={handleSearch} className="flex-1">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Semantic search within science funding articles..."
                className="w-full pl-10 pr-10 py-2 text-sm bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 dark:text-gray-100"
              />
              {localSearchQuery && (
                <button
                  type="button"
          ...
          <div className="flex gap-2">
            <select
              ...
              className="px-3 py-2 text-sm bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 dark:text-gray-100"
            >
          ...
          <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
            <div className="flex items-center justify-between mb-2">
              <p className="text-xs text-gray-500 dark:text-gray-300">
                Filter by science funding category
              </p>
              {selectedCategories.length > 0 && (
                <button
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex flex-col gap-1">
                  <button
                    ...
                    className="p-1.5 text-gray-500 hover:text-emerald-500 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 rounded transition-colors"
