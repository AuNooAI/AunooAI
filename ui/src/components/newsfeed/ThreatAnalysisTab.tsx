...
import { Target, Zap, Users, Globe, Shield, TrendingUp, AlertTriangle } from 'lucide-react';
import {
  getIOCs,
  getCampaigns,
  type IOC,
...
export function ThreatAnalysisTab({ loading: parentLoading, onCategoryFilter }: ThreatAnalysisTabProps) {
