/**
 * ScienceWatch Stats Component
 * Displays KPI cards with overview statistics
 */

import { FileText, Calendar, BarChart3, Layers } from 'lucide-react';
import type { ScienceStats } from '../../services/scienceFundingApi';

interface ScienceFundingStatsProps {
  stats: ScienceStats | null;
  loading: boolean;
}

export function ScienceFundingStats({ stats, loading }: ScienceFundingStatsProps) {
