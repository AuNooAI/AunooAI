...
export function SharedNavigation({ currentPage, onTopicEditorClick }: SharedNavigationProps) {
  ...
  return (
    <div className="w-64 shrink-0 bg-white dark:bg-gray-900 shadow-lg flex flex-col border-r border-gray-200 dark:border-gray-700 overflow-y-auto">
      {/* Logo/Brand */}
              ...
              <a
                ...
                className={`flex items-center gap-3 px-3 py-2.5 rounded-md text-sm transition-all ${
                  currentPage === 'health'
                    ...
                    : 'text-gray-800 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-pink-600'
                }`}
              >
          ...
          <ul className="space-y-0.5">
            ...
            <li>
              <button
                ...
                className="w-full flex items-center justify-between gap-3 px-3 py-2.5 rounded-md text-sm transition-all text-gray-800 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-pink-600"
              >
