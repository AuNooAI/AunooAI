          ...
          <ul className="space-y-0.5">
            ...
            <li>
              <button
                ...
                className="w-full flex items-center justify-between gap-3 px-3 py-2.5 rounded-md text-sm transition-all text-gray-700 hover:bg-gray-50 hover:text-pink-600"
              >
              ...
              {expandedSections.settings && (
                <ul className="mt-1 space-y-0.5">
                  <li>
                    <a href="/config" className="flex items-center gap-3 pl-10 pr-3 py-2 rounded-md text-sm text-gray-600 hover:bg-gray-50 hover:text-pink-600 transition-all">
                  ...
                  <li>
                    <a href="/create_topic" className="flex items-center gap-3 pl-10 pr-3 py-2 rounded-md text-sm text-gray-600 hover:bg-gray-50 hover:text-pink-600 transition-all">
                      <FolderPlus className="w-3.5 h-3.5" />
                      <span className="text-xs">Topic Editor</span>
                    </a>
                  </li>
                  <li>
                    <a href="/promptmanager" className="flex items-center gap-3 pl-10 pr-3 py-2 rounded-md text-sm text-gray-600 hover:bg-gray-50 hover:text-pink-600 transition-all">
                      <Brain className="w-3.5 h-3.5" />
                      <span className="text-xs">Prompt Engineering</span>
                    </a>
                  </li>
                  <li>
                    <a href="/model-bias-arena" className="flex items-center gap-3 pl-10 pr-3 py-2 rounded-md text-sm text-gray-600 hover:bg-gray-50 hover:text-pink-600 transition-all">
                      <Scale className="w-3.5 h-3.5" />
                      <span className="text-xs">Model Bias Arena</span>
                    </a>
                  </li>
                  <li>
                    <a href="/vector-analysis-improved" className="flex items-center gap-3 pl-10 pr-3 py-2 rounded-md text-sm text-gray-600 hover:bg-gray-50 hover:text-pink-600 transition-all">
                      <BarChart className="w-3.5 h-3.5" />
                      <span className="text-xs">Exploratory Analysis</span>
                    </a>
                  </li>
                  <li>
                    <a href="/database-editor" className="flex items-center gap-3 pl-10 pr-3 py-2 rounded-md text-sm text-gray-600 hover:bg-gray-50 hover:text-pink-600 transition-all">
                      <Edit className="w-3.5 h-3.5" />
                      <span className="text-xs">Database Editor</span>
                    </a>
                  </li>
                  <li>
                    <a href="/analytics" className="flex items-center gap-3 pl-10 pr-3 py-2 rounded-md text-sm text-gray-600 hover:bg-gray-50 hover:text-pink-600 transition-all">
            ...
            <li>
              ...
              {expandedSections.appInfo && (
                <ul className="mt-1 space-y-0.5">
                  <li>
                    <a href="/health/dashboard" className="flex items-center gap-3 pl-10 pr-3 py-2 rounded-md text-sm text-gray-600 hover:bg-gray-50 hover:text-pink-600 transition-all">
                      <Heart className="w-3.5 h-3.5" />
                      <span className="text-xs">System Health</span>
                    </a>
                  </li>
                  <li>
                    <a href="https://aunoo-ai.gitbook.io/aunoo-ai-kb" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 pl-10 pr-3 py-2 rounded-md text-sm text-gray-600 hover:bg-gray-50 hover:text-pink-600 transition-all">
                      <Book className="w-3.5 h-3.5" />
                      <span className="text-xs">Knowledge Base</span>
                    </a>
                  </li>
                  <li>
                    <a href="https://discord.gg/hEUNYDm5KH" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 pl-10 pr-3 py-2 rounded-md text-sm text-gray-600 hover:bg-gray-50 hover:text-pink-600 transition-all">
                      <MessageSquare className="w-3.5 h-3.5" />
                      <span className="text-xs">Discord Community</span>
                    </a>
                  </li>
                  <li>
                    <a href="https://chromewebstore.google.com/detail/aunoo-ai-chrome-browser-e/fjgiomiceklnoaefnhliablhgoodceji" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 pl-10 pr-3 py-2 rounded-md text-sm text-gray-600 hover:bg-gray-50 hover:text-pink-600 transition-all">
