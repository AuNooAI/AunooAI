...
async def generate_trend_convergence(
    ...
    try:
        ...
        # Fetch articles from database with consistent ordering for deterministic modes
        ...
        articles = db.fetch_all(query, (topic, start_date.isoformat(), end_date.isoformat(), optimal_sample_size * fetch_multiplier))
