# This is a placeholder for the enterprise relevance feature.
...
class RelevanceCalculator:
    ...
    def _initialize_model(self, model_name: str) -> None:
        ...
        try:
            # Try to get the model from static config first
            self.ai_model = get_ai_model(model_name)
            if self.ai_model is None:
                # Fall back to LiteLLM dynamic router
                logger.info(f"Model {model_name} not found in static config, using LiteLLM")
