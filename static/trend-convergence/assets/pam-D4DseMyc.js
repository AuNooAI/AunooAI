...
`;if(typeof document<"u"){const s=document.createElement("style");s.textContent=C,document.head.appendChild(s)}v.createRoot(document.getElementById("root")).render(e.jsx(A.StrictMode,{children:e.jsx(P,{children:e.jsx(k,{})})}));
