...
`;if(typeof document<"u"){const s=document.createElement("style");s.textContent=C,document.head.appendChild(s)}v.createRoot(document.getElementById("root")).render(e.jsx(P.StrictMode,{children:e.jsx(S,{children:e.jsx(k,{})})}));
