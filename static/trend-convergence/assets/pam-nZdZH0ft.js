...
`;if(typeof document<"u"){const n=document.createElement("style");n.textContent=P,document.head.appendChild(n)}j.createRoot(document.getElementById("root")).render(e.jsx(v.StrictMode,{children:e.jsx(w,{})}));
